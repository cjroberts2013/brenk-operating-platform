// =============================================================================
// REFERENCE — Tailwind UI "Dark sidebar with header" application shell
// =============================================================================
//
// Source: Tailwind UI / Tailwind Plus subscription (Charles's account).
// Shared by Charles on 2026-05-16 as the visual foundation for the Brenk
// Operating Platform dashboard.
//
// This file is NOT wired up — it lives here as a reference artifact for the
// Next.js scaffolding session. When we build the real shell under
// `frontend/`, we'll:
//   - Replace the placeholder navigation items with our actual routes
//     (Dashboard, Work Orders, Vendors, Reports, Settings)
//   - Replace the "Your teams" subsection with a "Vendors" quick-jump list
//   - Wire the user avatar/name to the signed-in Supabase user (not hardcoded
//     "Tom Cook")
//   - Replace the # href placeholders with real Next.js <Link> components
//   - Add a Sign Out action that calls Supabase Auth signOut()
//
// Dependencies this assumes:
//   - next (App Router; note the 'use client' directive at top)
//   - react
//   - @headlessui/react
//   - @heroicons/react
//   - tailwindcss (with dark mode enabled)
//
