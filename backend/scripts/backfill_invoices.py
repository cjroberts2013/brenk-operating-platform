...
HEADER_CANDIDATES: dict[str, list[str]] = {
    ...
    # SC's invoice export uses abbreviated headers ("Inv.Status", "Inv.Total",
    # "Inv. Date", "Last Payment Date"), confirmed against a real prod export
    # 2026-06-14 — included alongside the documented long forms.
    "status": ["status", "invoice status", "inv status"],
    "trade": ["trade", "trade name"],
    "category": ["category", "category name"],
    "description": ["description", "invoice text", "inv text", "resolution"],
    "currency": ["currency", "currency code"],
    "subtotal": ["subtotal", "sub total", "invoice subtotal"],
    "invoice_tax": ["tax", "invoice tax", "sales tax"],
    "invoice_total": ["invoice total", "inv total", "total amount", "total", "amount"],
    "approval_code": ["approval code", "approval #", "approval"],
    "batch_number": ["batch number", "batch #", "batch id", "batch"],
    "comments": ["comments", "comment", "notes"],
    "invoice_date": ["invoice date", "inv date", "date"],
    "posted_date": ["posted date"],
    "approved_date": ["approved date"],
    "paid_date": ["paid date", "payment date", "last payment date"],
